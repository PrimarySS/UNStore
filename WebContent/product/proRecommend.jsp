...
<div class="center">
	...
	<s:if test="#page > 1 "><a href="<%=context %>/recommendedproduct.action?page=1"> 首页</a></s:if>
					
	<s:if test="#page == 1 ">上一页</s:if>
					
	<s:if test="#page > 1 "><a href="<%=context %>/recommendedproduct.action?page=<s:property value="#page-1"/>"> 上一页</a></s:if>
					
	<s:if test="#page == #maxPage">下一页</s:if>
					
	<s:if test="#page < #maxPage "><a href="<%=context %>/recommendedproduct.action?page=<s:property value="#page+1"/>"> 下一页</a></s:if>
					
	<s:if test="#page == #maxPage">末页</s:if>
					
	<s:if test="#page < #maxPage  "><a href="<%=context %>/recommendedproduct.action?page=<s:property value="#maxPage"/>">末页</a></s:if>
